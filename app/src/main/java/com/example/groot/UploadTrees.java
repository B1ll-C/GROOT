...
public class UploadTrees extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_trees);
        ...
        tbx_tree = findViewById(R.id.tbx_tree);
    ...
    private  void uploadImage(){
        ...
        Date now = new Date();
        String filename = tbx_tree.getText().toString()+"_"+formatter.format(now);

        storageReference = FirebaseStorage.getInstance().getReference("tree/"+filename);
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadTrees.this,"Success", LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(UploadTrees.this,"Failed to Upload", LENGTH_SHORT).show();
