...
public class UploadPest extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_pest);
        ...
        tbx_pest = findViewById(R.id.tbx_pest);
    ...
    private  void uploadImage(){
        ...
        Date now = new Date();
        String filename = tbx_pest.getText().toString()+"_"+formatter.format(now);

        storageReference = FirebaseStorage.getInstance().getReference("pest/"+filename);
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadPest.this,"Success", LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(UploadPest.this,"Failed to Upload", LENGTH_SHORT).show();
